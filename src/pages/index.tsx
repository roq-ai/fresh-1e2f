  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Fresh - Your pathway to personalized nutrition. Explore customized meal plans, gain dietary guidance, and enrich your knowledge with our nutritional courses."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1490818387583-1baba5e638af?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxudXRyaXRpb258ZW58MHx8fHwxNjk1ODI0MTAzfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Fresh - Your pathway to personalized nutrition. Explore customized meal plans, gain dietary guidance, and enrich your knowledge with our nutritional courses.`}
            </Text>
            <Box
